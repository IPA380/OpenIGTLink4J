 ...
 * 
 */
public class GetTrajectoryMessage extends OIGTL_GetMessage {

    /** The messages data type */
    public static final String DATA_TYPE = "GET_TRAJ";
     ...
     *            Device Name
     **/
    public GetTrajectoryMessage(String deviceName) {
     ...
     */
    public GetTrajectoryMessage(Header header, byte body[]){
            super(header, body);
    }
}
