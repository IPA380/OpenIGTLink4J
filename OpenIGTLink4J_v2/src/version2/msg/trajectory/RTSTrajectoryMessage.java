 ...
 *
 */
public class RTSTrajectoryMessage extends OIGTL_RTSMessage {

    /** The messages data type */
	public static final String DATA_TYPE = "RTS_TRAJ";
	 ...
	 */
	public RTSTrajectoryMessage(String deviceName, RTSMessageStatus status) {
     ...
     */
	public RTSTrajectoryMessage(Header header, byte body[]) throws Exception {
	        super(header, body);
    }
}
