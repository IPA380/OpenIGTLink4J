...
/**
 *** This class create a GetString object from bytes received or help to generate
 * bytes to send from it
 * 
 * @author Andreas Rothfuss
 * 
 */
public class GetStringMessage extends OIGTL_GetMessage {

    /** The messages data type */
	public static final String DATA_TYPE = "GET_STRING";
     ...
     */
	public GetStringMessage(Header header, byte[] body){
		super(header, body);
	}
     ...
     *            Device Name
     **/
	public GetStringMessage(String deviceName){
