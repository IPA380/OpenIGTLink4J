 ...
 * 
 */
public class GetQuaternionTrackingDataMessage extends OIGTL_GetMessage {

    /** The messages data type */
	public static final String DATA_TYPE = "GET_QTDATA";
     ...
     *            Device Name
     **/
    public GetQuaternionTrackingDataMessage(String deviceName) {
     ...
     */
    public GetQuaternionTrackingDataMessage(Header header, byte body[]) {
            super(header, body);
    }
