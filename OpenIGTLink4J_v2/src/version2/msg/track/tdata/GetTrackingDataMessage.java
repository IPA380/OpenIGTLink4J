 ...
 * 
 */
public class GetTrackingDataMessage extends OIGTL_GetMessage {

    /** The messages data type */
	public static final String DATA_TYPE = "GET_TDATA";
     ...
     *            Device Name
     **/
    public GetTrackingDataMessage(String deviceName) {
     ...
     */
    public GetTrackingDataMessage(Header header, byte body[]) {
            super(header, body);
    }
