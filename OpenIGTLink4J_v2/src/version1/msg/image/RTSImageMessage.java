 ...
 *
 */
public class RTSImageMessage extends OIGTL_RTSMessage {

    /** The messages data type */
	public static final String DATA_TYPE = "RTS_IMAGE";
	 ...
	 */
	public RTSImageMessage(String deviceName, RTSMessageStatus status) {
     ...
     */
    public RTSImageMessage(Header header, byte body[]) {
            super(header, body);
    }
